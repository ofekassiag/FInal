<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CitizenList.aspx.cs" Inherits="Project.CitizenList" %>
...
<head>
    ...
    <style>
        ...
        h1 {
            font-size: 24px;
            font-weight: bold;
            margin-bottom: 10px; /* Reduce the margin-bottom value */
            color: #e60012;
        ...
        .disclaimer-text {
            font-size: 12px;
            color: #777;
            margin-top: 10px; /* Reduce the margin-top value */
        }
    </style>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <h1>Citizen List<span class="emoji">📋</span></h1>
            ...
            <asp:GridView runat="server" ID="UserGridView" CssClass="user-gridview" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField HeaderText="I.D" DataField="didi" />
